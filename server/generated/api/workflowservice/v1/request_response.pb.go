...
import (
	...
	v17 "github.com/temporalio/ui-server/v2/server/generated/api/command/v1"
	v13 "github.com/temporalio/ui-server/v2/server/generated/api/common/v1"
	v11 "github.com/temporalio/ui-server/v2/server/generated/api/enums/v1"
	v18 "github.com/temporalio/ui-server/v2/server/generated/api/failure/v1"
	v19 "github.com/temporalio/ui-server/v2/server/generated/api/filter/v1"
	v15 "github.com/temporalio/ui-server/v2/server/generated/api/history/v1"
	v12 "github.com/temporalio/ui-server/v2/server/generated/api/namespace/v1"
	v16 "github.com/temporalio/ui-server/v2/server/generated/api/query/v1"
	v1 "github.com/temporalio/ui-server/v2/server/generated/api/replication/v1"
	v112 "github.com/temporalio/ui-server/v2/server/generated/api/schedule/v1"
	v14 "github.com/temporalio/ui-server/v2/server/generated/api/taskqueue/v1"
	v111 "github.com/temporalio/ui-server/v2/server/generated/api/version/v1"
	v110 "github.com/temporalio/ui-server/v2/server/generated/api/workflow/v1"
	io "io"
	math "math"
	math_bits "math/bits"
	reflect "reflect"
...
func (m *GetWorkflowExecutionHistoryReverseResponse) GetHistory() *v15.History {
	if m != nil {
		return m.History
	}
	return nil
...
type RespondActivityTaskFailedResponse struct {
	...
	Failures []*v18.Failure `protobuf:"bytes,1,rep,name=failures,proto3" json:"failures,omitempty"`
}
...
func (m *RespondActivityTaskFailedResponse) GetFailures() []*v18.Failure {
	if m != nil {
		return m.Failures
	}
	return nil
...
func (m *RespondActivityTaskFailedByIdResponse) GetFailures() []*v18.Failure {
	if m != nil {
		return m.Failures
	}
	return nil
...
func (*GetSystemInfoResponse_Capabilities) Descriptor() ([]byte, []int) {
	return fileDescriptor_2c30b34f996ae016, []int{77, 0}
}
...
type CreateScheduleRequest struct {
	...
	Schedule *v112.Schedule `protobuf:"bytes,3,opt,name=schedule,proto3" json:"schedule,omitempty"`
	// Optional initial patch (e.g. to run the action once immediately).
	InitialPatch *v112.SchedulePatch `protobuf:"bytes,4,opt,name=initial_patch,json=initialPatch,proto3" json:"initial_patch,omitempty"`
	// The identity of the client who initiated this request.
	Identity string `protobuf:"bytes,5,opt,name=identity,proto3" json:"identity,omitempty"`
...
func (m *CreateScheduleRequest) GetSchedule() *v112.Schedule {
	if m != nil {
		return m.Schedule
	}
	return nil
...
func (m *CreateScheduleRequest) GetInitialPatch() *v112.SchedulePatch {
	if m != nil {
...
type DescribeScheduleResponse struct {
	...
	Info *v112.ScheduleInfo `protobuf:"bytes,2,opt,name=info,proto3" json:"info,omitempty"`
...
func (m *DescribeScheduleResponse) GetSchedule() *v112.Schedule {
	if m != nil {
		return m.Schedule
	}
	return nil
...
func (m *DescribeScheduleResponse) GetInfo() *v112.ScheduleInfo {
	if m != nil {
		return m.Info
	}
	return nil
...
func (m *UpdateScheduleRequest) GetSchedule() *v112.Schedule {
	if m != nil {
		return m.Schedule
	}
	return nil
...
type PatchScheduleRequest struct {
	...
	ScheduleId string              `protobuf:"bytes,2,opt,name=schedule_id,json=scheduleId,proto3" json:"schedule_id,omitempty"`
	Patch      *v112.SchedulePatch `protobuf:"bytes,3,opt,name=patch,proto3" json:"patch,omitempty"`
	// The identity of the client who initiated this request.
	Identity string `protobuf:"bytes,4,opt,name=identity,proto3" json:"identity,omitempty"`
	// A unique identifier for this update request for idempotence. Typically UUIDv4.
	RequestId string `protobuf:"bytes,5,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
...
func (m *PatchScheduleRequest) GetPatch() *v112.SchedulePatch {
	if m != nil {
		return m.Patch
	}
	return nil
...
type ListSchedulesResponse struct {
	Schedules     []*v112.ScheduleListEntry `protobuf:"bytes,1,rep,name=schedules,proto3" json:"schedules,omitempty"`
	NextPageToken []byte                    `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
}
...
func (m *ListSchedulesResponse) GetSchedules() []*v112.ScheduleListEntry {
	if m != nil {
		return m.Schedules
	}
	return nil
...
var fileDescriptor_2c30b34f996ae016 = []byte{
	...
	,
}
...
func (m *PollWorkflowTaskQueueResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.StartedTime != nil {
		n27, err27 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.StartedTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.StartedTime):])
		if err27 != nil {
			return 0, err27
		}
		i -= n27
	...
	if m.ScheduledTime != nil {
		n28, err28 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.ScheduledTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.ScheduledTime):])
		if err28 != nil {
			return 0, err28
		}
		i -= n28
...
func (m *PollActivityTaskQueueResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HeartbeatTimeout != nil {
		n41, err41 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.HeartbeatTimeout, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(*m.HeartbeatTimeout):])
		if err41 != nil {
			return 0, err41
		}
		i -= n41
	...
	if m.StartToCloseTimeout != nil {
		n42, err42 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.StartToCloseTimeout, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(*m.StartToCloseTimeout):])
		if err42 != nil {
			return 0, err42
		}
		i -= n42
	...
	if m.ScheduleToCloseTimeout != nil {
		n43, err43 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.ScheduleToCloseTimeout, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(*m.ScheduleToCloseTimeout):])
		if err43 != nil {
			return 0, err43
		}
		i -= n43
	...
	if m.StartedTime != nil {
		n44, err44 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.StartedTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.StartedTime):])
		if err44 != nil {
			return 0, err44
		}
		i -= n44
	...
	if m.ScheduledTime != nil {
		n46, err46 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.ScheduledTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.ScheduledTime):])
		if err46 != nil {
			return 0, err46
		}
		i -= n46
...
func (m *SignalWithStartWorkflowExecutionRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.WorkflowTaskTimeout != nil {
		n72, err72 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.WorkflowTaskTimeout, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(*m.WorkflowTaskTimeout):])
		if err72 != nil {
			return 0, err72
		}
		i -= n72
	...
	if m.WorkflowRunTimeout != nil {
		n73, err73 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.WorkflowRunTimeout, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(*m.WorkflowRunTimeout):])
		if err73 != nil {
			return 0, err73
		}
		i -= n73
		i = encodeVarintRequestResponse(dAtA, i, uint64(n73))
		i--
		dAtA[i] = 0x3a
	}
	if m.WorkflowExecutionTimeout != nil {
		n74, err74 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.WorkflowExecutionTimeout, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(*m.WorkflowExecutionTimeout):])
		if err74 != nil {
			return 0, err74
		}
		i -= n74
		i = encodeVarintRequestResponse(dAtA, i, uint64(n74))
		i--
		dAtA[i] = 0x32
	}
	if m.Input != nil {
...
func (m *ListScheduleMatchingTimesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.EndTime != nil {
		n113, err113 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.EndTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.EndTime):])
		if err113 != nil {
			return 0, err113
		}
		i -= n113
	...
	if m.StartTime != nil {
		n114, err114 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.StartTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.StartTime):])
		if err114 != nil {
			return 0, err114
		}
		i -= n114
...
func (this *RespondActivityTaskFailedResponse) String() string {
	...
	for _, f := range this.Failures {
		repeatedStringForFailures += strings.Replace(fmt.Sprintf("%v", f), "Failure", "v18.Failure", 1) + ","
	}
...
func (this *CreateScheduleRequest) String() string {
	...
	s := strings.Join([]string{`&CreateScheduleRequest{`,
		...
		`Schedule:` + strings.Replace(fmt.Sprintf("%v", this.Schedule), "Schedule", "v112.Schedule", 1) + `,`,
		`InitialPatch:` + strings.Replace(fmt.Sprintf("%v", this.InitialPatch), "SchedulePatch", "v112.SchedulePatch", 1) + `,`,
		`Identity:` + fmt.Sprintf("%v", this.Identity) + `,`,
		`RequestId:` + fmt.Sprintf("%v", this.RequestId) + `,`,
		`Memo:` + strings.Replace(fmt.Sprintf("%v", this.Memo), "Memo", "v13.Memo", 1) + `,`,
		`SearchAttributes:` + strings.Replace(fmt.Sprintf("%v", this.SearchAttributes), "SearchAttributes", "v13.SearchAttributes", 1) + `,`,
...
func (this *DescribeScheduleResponse) String() string {
	...
	s := strings.Join([]string{`&DescribeScheduleResponse{`,
		`Schedule:` + strings.Replace(fmt.Sprintf("%v", this.Schedule), "Schedule", "v112.Schedule", 1) + `,`,
		`Info:` + strings.Replace(fmt.Sprintf("%v", this.Info), "ScheduleInfo", "v112.ScheduleInfo", 1) + `,`,
		`Memo:` + strings.Replace(fmt.Sprintf("%v", this.Memo), "Memo", "v13.Memo", 1) + `,`,
		`SearchAttributes:` + strings.Replace(fmt.Sprintf("%v", this.SearchAttributes), "SearchAttributes", "v13.SearchAttributes", 1) + `,`,
		`ConflictToken:` + fmt.Sprintf("%v", this.ConflictToken) + `,`,
		`}`,
...
func (this *PatchScheduleRequest) String() string {
	...
	s := strings.Join([]string{`&PatchScheduleRequest{`,
		`Namespace:` + fmt.Sprintf("%v", this.Namespace) + `,`,
		`ScheduleId:` + fmt.Sprintf("%v", this.ScheduleId) + `,`,
		`Patch:` + strings.Replace(fmt.Sprintf("%v", this.Patch), "SchedulePatch", "v112.SchedulePatch", 1) + `,`,
		`Identity:` + fmt.Sprintf("%v", this.Identity) + `,`,
		`RequestId:` + fmt.Sprintf("%v", this.RequestId) + `,`,
		`}`,
	}, "")
...
func (this *ListSchedulesResponse) String() string {
	...
	for _, f := range this.Schedules {
		repeatedStringForSchedules += strings.Replace(fmt.Sprintf("%v", f), "ScheduleListEntry", "v112.ScheduleListEntry", 1) + ","
	}
...
func (m *RespondActivityTaskFailedResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Failures = append(m.Failures, &v18.Failure{})
...
func (m *CreateScheduleRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.InitialPatch == nil {
				m.InitialPatch = &v112.SchedulePatch{}
			}
...
func (m *ListSchedulesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Schedules = append(m.Schedules, &v112.ScheduleListEntry{})
